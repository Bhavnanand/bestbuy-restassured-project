...
response.body("data.name",hasItems("(Duracell - AA 1.5V CopperTop Batteries (4-Pack)","Duracell - AA Batteries (8-Pack)","Duracell - AA Batteries (8-Pack), Energizer - MAX Batteries AA (4-Pack))"));
...
@Test
    public void test0016(){
        response.body("data[8].categories[1].name",hasItem("Housewares"));
}
